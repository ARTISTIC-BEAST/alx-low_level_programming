...
/**
 * free_skiplist - Frees the memory allocated for the skiplist
 *
 * @list: Pointer to the head node of the skiplist
 */
...
/**
 * create_skiplist - Create a singly linked list with an express lane
 *
